...
public class GuessRecyclerAdapter extends RecyclerView.Adapter<Holder> {
  ...
  public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    // managing a list of a thousand model objects; all we need is 10 holder items on screen\
    // inflate a view and pass it to the holder so it can work with the view object
  ...
  public void onBindViewHolder(@NonNull Holder holder, int position) {
    // we just scrolled so adapter i need you to display item 10 and it just became visible
