...
public class ScoreSummaryAdapter extends ArrayAdapter<ScoreSummary> {
  ...
  private final String averageGuessesFormat; // must be assigned during instance initialization
  ...
  public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ...
    binding.codeLength.setText(String.valueOf(summary.getCodeLength())); // int id referring to resource id int
